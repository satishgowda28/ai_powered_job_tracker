...
SELECT token, user_id, expires_at, revoked_at, created_at, updated_at FROM user_refresh_token
WHERE token = $1
`

func (q *Queries) GetRefreshToken(ctx context.Context, token string) (UserRefreshToken, error) {
